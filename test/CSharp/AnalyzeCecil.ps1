...
$analyzerCommonDll = [System.IO.Path]::GetFullPath("$PSScriptRoot\..\..\src\CSharp\ExxeRules\bin\Release\ExxeRules.Common.dll")
...
$ccBuildErrors = cat $logFile | Select-String "info AD0001: The Compiler Analyzer 'ExxeRules"
