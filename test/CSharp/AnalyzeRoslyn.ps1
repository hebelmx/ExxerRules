...
$analyzerDll = [System.IO.Path]::GetFullPath("$PSScriptRoot\..\..\src\CSharp\ExxeRules\bin\Release\ExxeRules.CSharp.dll")
$analyzerDllVB = [System.IO.Path]::GetFullPath("$PSScriptRoot\..\..\src\VisualBasic\ExxeRules\bin\Release\ExxeRules.VisualBasic.dll")
...
$ccBuildErrors = cat $logFile | Select-String "info AnalyzerDriver: The Compiler Analyzer 'ExxeRules"
